    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="downloads">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" target="_blank" href="{{ env('GOOGLE_DRIVE') }}">Google
                            Drive</a></li>
                    <li class="nav-item"> <a class="nav-link" target="_blank" href="{{ env('ONE_DRIVE') }}">OneDrive</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" target="_blank" href="{{ env('MEGA_NZ') }}">Mega.nz</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" target="_blank"
                            href="{{ env('MEDIA_FIRE') }}">Mediafire</a>
                    </li>
                </ul>
            </div>
        </li>
